...
namespace GigHub.Controllers
{
    public class GigsController : Controller
    {
        ...
        {
            var gig = _context.Gigs.Include(g => g.Artist).Include(g => g.Genre).Single(g => g.Id == id);
            ...
            if (User.Identity.IsAuthenticated) {
                ...
                viewModel.IsGoing = _context.Attendances.Any(a => a.AttendeeId == userId && a.GigId == id);
